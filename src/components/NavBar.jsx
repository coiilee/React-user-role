                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li><Link className="dropdown-item" to="/posts/search">게시글 검색</Link></li>

                                <li>
                                    <hr className="dropdown-divider"/>
                                </li>
                                <li><Link className="dropdown-item" to="/posts/create">게시물 작성</Link></li>
                            </ul>
                        </li>
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <ul className="dropdown-menu">
                                <li><Link className="dropdown-item" to="/clothes">의류목록</Link></li>
...
const NavBars = ({user}) => {
    return (
        <div className="NavBar-container">
            ...
            <Link to="/posts/create">게시물 작성</Link>
            ...
            ?.
            user 정보가 null 또는 undefined 일 경우
            대비해서 존재할 경우에만 사용할 수 있도록 설정
            */}
            {user?.role === 1 && (
